...
class Tracker:
    ...
    def interpolate_ball_positions(self, ball_positions):
        # Extract bbox or NaNs if missing
        extracted_bboxes = []
        for x in ball_positions:
            ...
            if bbox and isinstance(bbox, (list, tuple)) and len(bbox) == 4:
                ...
                extracted_bboxes.append([np.nan, np.nan, np.nan, np.nan])
        ...
        ball_positions_interpolated = [{1: {"bbox": x}} for x in df_ball_positions.to_numpy().tolist()]
